...
function draw_dist_pts_3d_new(ave_final_dist_struct1, x_pos_dist, y_pos_dist, z_pos_dist,...
...
%     tem_x = repmat(x_pos_dist,[sz_y_dist, 1]);
%     tem_y = zeros(sz_y_dist,sz_x_dist);
%     tem_y = repmat(x_pos_dist',[1,sz_x_dist]);
