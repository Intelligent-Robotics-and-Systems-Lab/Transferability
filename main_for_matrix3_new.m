...
pre_adult_l1 = 261;
pre_adult_l2 = 283; % sum length of arm = 544
...
pre_kid_l1 = 206;
pre_kid_l2 = 208;  % sum length of arm = 414
...
pre_pepper_l1 = round(norm([15, 181.20, 0.13]));
pre_pepper_l2 = round(norm([-23.60, 150, 22.84]));
...
%% Capability new 
lin_shape_struct1 = lin_shape_struct1_new;
lin_shape_struct2 = lin_shape_struct2_new;
% remap lin_shape_struct1
re_lin_shape_struct1 = lin_shape_struct1;
re_lin_shape_struct1(re_lin_shape_struct1 <= 0 ) = 100;
[r,c,v] = find(re_lin_shape_struct1 < 99);
total_num = size(c,2);

diff_capa = lin_shape_struct2 - re_lin_shape_struct1;
